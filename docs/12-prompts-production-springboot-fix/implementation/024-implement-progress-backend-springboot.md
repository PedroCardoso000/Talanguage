...
- `docs/05-features/progress/feature-spec.md`, se existir
- `docs/05-features/progress/domain-spec.md`, se existir
- `docs/05-features/progress/api-spec.md`, se existir
- `docs/05-features/progress/backend-spec.md`, se existir
- `docs/05-features/progress/frontend-spec.md`, se existir
- `docs/05-features/progress/test-spec.md`, se existir
- `docs/06-skills/fullstack/criar-feature-ponta-a-ponta/SKILL.md`
- `docs/06-skills/fullstack/integrar-frontend-backend/SKILL.md`

## Objetivo

Implementar progress backend real usando Spring Boot no backend e preservando a UI existente no frontend.

## Execute


1. Implementar read model de progresso do usuário.
2. Criar endpoints para resumo de progresso, métricas e evolução semanal.
3. Criar use cases de consulta e atualização por evento/ação quando necessário.
4. Tirar cálculo principal de progresso do frontend.
5. Criar testes unitários e API.
